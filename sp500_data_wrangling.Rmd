...
library(timeDate) # for time series analysis
library(ggplot2) # for data visualization
library(reshape2) # for data manipulation
options(pillar.sigfig = 6) # set number of significant digits
```
